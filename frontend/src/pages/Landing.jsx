  ...
  return (
    <div className="space-y-24 py-10 relative">
      ...
      <section className="min-h-[75vh] flex flex-col justify-center items-center text-center relative px-4">
        ...
        >
          Ink & Echoes — A digital museum of classical poetry, long-form thoughts, and personal reflections.
        </motion.p>
        ...
        >
          <Link
            to="/library"
            className="px-8 py-4 border border-luxury-gold bg-luxury-gold/5 text-luxury-gold hover:bg-luxury-gold hover:text-black rounded-full font-semibold uppercase tracking-wider text-xs flex items-center gap-2 transition-all duration-300 shadow-gold-glow"
          >
            <Feather size={14} /> Read Poems
          </Link>
          <Link
            to="/thoughts"
            className="px-8 py-4 border border-luxury-border bg-luxury-card hover:border-white rounded-full font-semibold uppercase tracking-wider text-xs flex items-center gap-2 transition-all duration-300"
          >
            <BookOpen size={14} /> Explore Thoughts
          </Link>
          <Link
            to="/contact"
            className="px-8 py-4 border border-transparent text-luxury-muted hover:text-white rounded-full font-semibold uppercase tracking-wider text-xs flex items-center gap-2 transition-all duration-300"
          >
